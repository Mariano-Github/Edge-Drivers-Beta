      ...
      if oldPreferenceValue ~= newParameterValue then
        ...
        if id == "childThermostat" and device.preferences.childThermostat == true then
          if device.preferences.changeProfileExtTemp == "10" then
            child_devices.create_new(driver, device, "main", "child-thermostat-05")
          else
        ...
        elseif id == "childThermostat3" and device.preferences.childThermostat3 == true then
          child_devices.create_new(driver, device, "externalTemp3", "child-thermostat-05")
        elseif id == "childThermostat4" and device.preferences.childThermostat4 == true then
          child_devices.create_new(driver, device, "externalTemp4", "child-thermostat-05")
        elseif id == "childThermostat5" and device.preferences.childThermostat5 == true then
          child_devices.create_new(driver, device, "externalTemp5", "child-thermostat-05")
        elseif id == "childThermostat6" and device.preferences.childThermostat6 == true then
          child_devices.create_new(driver, device, "externalTemp6", "child-thermostat-05")
        elseif id == "childContact1" and device.preferences.childContact1 == true then
          child_devices.create_new(driver, device, "in1", "child-contact")
        elseif id == "childContact2" and device.preferences.childContact2 == true then
          child_devices.create_new(driver, device, "in2", "child-contact")
        elseif id == "childMotion1" and device.preferences.childMotion1 == true then
          child_devices.create_new(driver, device, "in1", "child-motion")
        elseif id == "childMotion2" and device.preferences.childMotion2 == true then
          child_devices.create_new(driver, device, "in2", "child-motion")
        elseif id == "childOut1" and device.preferences.childOut1 == true then
          child_devices.create_new(driver, device, "out1", "child-switch")
        elseif id == "childOut2" and device.preferences.childOut2 == true then
          child_devices.create_new(driver, device, "out2", "child-switch")
        elseif id == "childVoltage1" and device.preferences.childVoltage1 == true then
          child_devices.create_new(driver, device, "analog1", "child-voltage")
        elseif id == "childVoltage2" and device.preferences.childVoltage2 == true then
          child_devices.create_new(driver, device, "analog2", "child-voltage")
        elseif id == "changeProfileExtTemp" then
          ...
          elseif newParameterValue == "9" then
            if device.preferences.deviceTile == false or device.preferences.deviceTile == nil then
          ...
          elseif newParameterValue == "10" then
            if device.preferences.deviceTile == false or device.preferences.deviceTile == nil then
          ...
          elseif newParameterValue == "11" then
            if device.preferences.deviceTile == false or device.preferences.deviceTile == nil then
          ...
          elseif newParameterValue == "12" then
            if device.preferences.deviceTile == false or device.preferences.deviceTile == nil then
        ...
        elseif id == "deviceTile" then
          ...
          elseif newParameterValue == true then
            if device.preferences.changeProfileExtTemp == "0" then -- multi-tile profile
              device:try_update_metadata({profile = "smart-implant-two-switch-multi"})
            elseif device.preferences.changeProfileExtTemp == "7" then
              device:try_update_metadata({profile = "smart-implant-two-contact-switch-multi"})
            elseif device.preferences.changeProfileExtTemp == "8" then
