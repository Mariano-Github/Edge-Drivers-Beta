...
local devices = {
  ...
  FIBARO = {
    ...
    PARAMETERS = {
      ...
      timeDwonMovement =          {parameter_number = 157, size = 4},
  ...
  FIBARO_2 = {
    MATCHING_MATRIX = {
      mfrs = 0x010F,
      product_types = {0x0301, 0x0302},
      product_ids = {0x1000,0x1001},
    },
    PARAMETERS = {
      operatingMode =             {parameter_number = 10, size = 1},
      switchType =                {parameter_number = 14, size = 1},
      turnOffLimitSwitch =        {parameter_number = 17, size = 1},
      motorEndMoveDetection =     {parameter_number = 18, size = 1},
      motorOperationTime =        {parameter_number = 22, size = 2},
      calibration =               {parameter_number = 29, size = 1},
      powerReportsOnChange =      {parameter_number = 40, size = 1},
      energyReportsPeriodic =     {parameter_number = 42, size = 2},
      energyReportsOnChange =     {parameter_number = 43, size = 1},
      powerWithSelfConsumption =  {parameter_number = 44, size = 1},
    }
  },
  FIBARO_3 = {
    MATCHING_MATRIX = {
  ...
  FIBARO_4 = {
    ...
    PARAMETERS = {
      ...
      calibration =               {parameter_number = 150, size = 1},
      operatingMode =             {parameter_number = 151, size = 1},
      venetianBlindTurnTime =     {parameter_number = 152, size = 2},
      timeUpMovement =            {parameter_number = 156, size = 2},
      timeDwonMovement =          {parameter_number = 157, size = 2},
      virtualLimit =              {parameter_number = 158, size = 1},
      favoritePositionOpen =      {parameter_number = 159, size = 1},
      favoritePositionSlat =      {parameter_number = 160, size = 1}
    }
  },
  IBLINDS_V3 = {
    MATCHING_MATRIX = {
